          ...
          <ImpactStat
            icon={
              <svg width="65" height="65" viewBox="0 0 65 65" fill="none" xmlns="http://www.w3.org/2000/svg" className="mx-auto">
                <path d="M0.5 20.5L32.5 0.5L64.5 20.5H0.5Z" fill={BG} stroke={FG} strokeLinecap="round" strokeLinejoin="round"/>
                <rect x="25.5" y="12.5" width="14" height="4" fill={MUT} stroke={FG} strokeLinecap="round" strokeLinejoin="round"/>
                <rect x="2.5" y="20.5" width="1" height="44" rx="0.5" fill={FG}/>
                <rect x="61.5" y="20.5" width="1" height="44" rx="0.5" fill={FG}/>
                <path d="M12.2545 39.5077C11.4767 38.1744 12.4385 36.5 13.9821 36.5H51.0179C52.5615 36.5 53.5233 38.1744 52.7455 39.5077L48.0788 47.5077C47.7204 48.1222 47.0626 48.5 46.3513 48.5H18.6487C17.9374 48.5 17.2796 48.1222 16.9212 47.5077L12.2545 39.5077Z" fill={FG}/>
                <path d="M8.5 48.5C8.5 44.0817 12.0817 40.5 16.5 40.5H48.5C52.9183 40.5 56.5 44.0817 56.5 48.5V57.5H8.5V48.5Z" fill="hsl(var(--accent))" stroke={FG} strokeLinecap="round" strokeLinejoin="round"/>
                <path d="M16.4107 33.8444C17.1491 31.2722 19.5017 29.5 22.1778 29.5H42.8222C45.4983 29.5 47.8509 31.2722 48.5893 33.8444L50.5 40.5H14.5L16.4107 33.8444Z" fill={BG} stroke={FG} strokeLinecap="round" strokeLinejoin="round"/>
                <circle cx="50.5" cy="51.5" r="3" fill={BG} stroke={FG} strokeLinecap="round" strokeLinejoin="round"/>
                <circle cx="14.5" cy="51.5" r="3" fill={BG} stroke={FG} strokeLinecap="round" strokeLinejoin="round"/>
                <path d="M21.5 53.6818C21.5 49.1631 25.1631 45.5 29.6818 45.5H35.3182C39.8369 45.5 43.5 49.1631 43.5 53.6818C43.5 54.1337 43.1337 54.5 42.6818 54.5H22.3182C21.8663 54.5 21.5 54.1337 21.5 53.6818Z" fill={BG} stroke={FG} strokeLinecap="round" strokeLinejoin="round"/>
                <path d="M11.5 57.5H17.5V61.5C17.5 63.1569 16.1569 64.5 14.5 64.5C12.8431 64.5 11.5 63.1569 11.5 61.5V57.5Z" fill={MUT} stroke={FG}/>
                <path d="M47.5 57.5H53.5V61.5C53.5 63.1569 52.1569 64.5 50.5 64.5C48.8431 64.5 47.5 63.1569 47.5 61.5V57.5Z" fill={MUT} stroke={FG}/>
                <path d="M46.5 40.5C46.5 37.7386 44.0376 35.5 41 35.5C37.9624 35.5 35.5 37.7386 35.5 40.5" stroke={FG} strokeLinecap="round" strokeLinejoin="round"/>
              </svg>
            }
          ...
          <ImpactStat
            icon={
              <svg width="64" height="64" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" className="mx-auto">
                ...
                <rect x="42" y="5" width="20" height="43" rx="10" fill={PRI20} stroke={FG} strokeLinecap="round" strokeLinejoin="round"/>
